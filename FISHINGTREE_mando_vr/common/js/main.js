...
/*
				if(activeNo == 1){
					$(".next").attr("src","/images/common/btn/btn_main_next.png")					
				}else if(activeNo == 2){
					$(".next").attr("src","/images/common/btn/btn_main_next_blue.png")
					$(".prev").attr("src","/images/common/btn/btn_main_prev_blue.png")
				}
*/
				if(1 == activeNo){$(".prev").hide();}else{$(".prev").show()}
	...
	$(".next").click(function(){
		...
		if(activeNo >= 0 && activeNo < maxNo-1){
			if(aniFlag == false){
				...
				$(".prev").show();
				if((maxNo - 2) == activeNo){$(".next").hide();}else{$(".next").show()}
/*
				if(activeNo == 0){
					$(".next").attr("src","/images/common/btn/btn_main_next_blue.png")
					$(".prev").attr("src","/images/common/btn/btn_main_prev_blue.png")
				}else if(activeNo == 1){
					$(".prev").attr("src","/images/common/btn/btn_main_prev_brown.png")
				}
*/
				$visualTxt.eq(activeNo).stop().animate({left:-visualTxtPos},speed2, easing2, function(){
					$visualTxt.eq(activeNo+1).stop().animate({left:"0px"},speed2, easing2)
