...
function initMain()
	...
	var naviSub01 = document.getElementById("naviSub01") 
	var subMenuList = getChildElementNodes(naviSub01) 
	for (var j=0 ; j<subMenuList.length ; j++)
		{
		var sa = subMenuList[j].getElementsByTagName("a")[0] 
	...
	for (var i=0 ; i<boardBoxList.length ; i++)
		...
		//텝은 브라우저 로딩이 되자마자 1나이상이 이미 보여져 있어야하기 때문에
