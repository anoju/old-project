...
<div id="eventWrap">
	...
	<div id="navContainer" class="clearfix ie_clearfix">
		<ul id="nav">
			...
			<li class="n_1"><a href="scoreRank.asp"><img src="/image/common/mn_01.gif" alt="Ranking" /></a></li>
			<li class="n_2"><a href="#"><img class="active" src="/image/common/mn_02.gif" alt="Event" /></a></li>
			<li class="n_3"><a href="inviteFriends.asp"><img src="/image/common/mn_03.gif" alt="Invite Friends" /></a></li>
		</ul>
	</div>
	<div id="content_event">
		<p class="evtDesc"><img src="/image/event/evtDescription.png"></p>
		<p class="evtPeriod"><img src="/image/event/evtPeriod.gif"></p>
		<p class="evtMonkey"><img src="/image/event/monkey.png"></p>
		<p class="showroom"></p>
		<!--
		<ul class="prize">
			<li class="p_00"><img src="/image/event/evt_00.jpg"><span></span></li>
			<li class="p_01"><img src="/image/event/evt_01.png"></li>
			<li class="p_02"><img src="/image/event/evt_02.png"></li>
		</ul>
		-->
	</div>
</div>
