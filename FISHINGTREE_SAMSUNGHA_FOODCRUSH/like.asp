...
<div id="likeWrap">
	...
	<div id="navContainer" class="clearfix ie_clearfix">
		<ul id="nav">
			...
			<li class="n_2"><a href="#"><img src="/image/common/mn_02.gif" alt="Event" /></a></li>
			<li class="n_3"><a href="inviteFriends.asp"><img src="/image/common/mn_03.gif" alt="Invite Friends" /></a></li>
		</ul>
	</div>
	<div id="content_like">
		<div class="fb-like" data-href="https://www.facebook.com/SamsungHomeAppliances" data-send="false" data-layout="button_count" data-width="150" data-show-faces="true"></div>
		<div class="btnNext"><a href="#"><img src="/image/common/btnNext.png"></a></div>
	</div>
</div>
