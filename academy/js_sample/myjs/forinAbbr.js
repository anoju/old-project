// JavaScript Document
function myDisplayAbbr(){
	//구종 불가능시 자바 스크립트 끄기
	if(!document.getElementsByTagName||!document.getElementById||!document.createTextNode){
		return false		
		}
	...
	//문서내의 abbr 다 가져오기
	 ...
	 //if(myAbbr.length<1)return false              <----이렇게 표현 가능
		 if(myAbbr.length<1){
		 return false
		 }
