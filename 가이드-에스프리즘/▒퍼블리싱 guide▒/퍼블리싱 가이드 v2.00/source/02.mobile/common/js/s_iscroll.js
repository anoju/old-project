...
function iScroll (el, options) {
	...
	// ÆË¾÷´Ý±â ÈÄ iScrollÀÌ ¸ÔÅëÀÌ µÇ´Â Çö»ó¹æÁö
...
iScroll.prototype = {
    ...
    touchStart: function(e) {
        ...
        if (that.options.disableTouchEvents){
            e.preventDefault();
        }
    ...
    touchMove: function(e) {
        ...
        if (that.distX + that.distY > 40) {         // 5 pixels threshold
            //Added this code to prevent default scrolling when swiping
            e.preventDefault();
            e.stopPropagation();
    ...
    touchEnd: function(e) {
        ...
        if (!that.moved) {
            ...
            if (isTouch) {
                ...
                //Commented the following code to prevent triggering click event when scrolling up/down
