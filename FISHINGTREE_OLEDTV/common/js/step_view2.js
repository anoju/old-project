...
//	clearInterval  ( scrollTimer ) ;
	...
	if (UserAgent.match(/iPhone|ipad|iPod|Android|Windows CE|BlackBerry|Symbian|Windows Phone|webOS|Opera Mini|Opera Mobi|POLARIS|IEMobile|lgtelecom|nokia|SonyEricsson|LG|SAMSUNG|Samsung/) != null && $(window).width() >= 768){
	  fixedLeft.css({"position":"absolute","top":(window.pageYOffset)});
	}
