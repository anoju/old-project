...
function fbshare(){
	...
	fbtitle = encodeURIComponent("ABOVE AND BEYOND – LG OLED TV");
	fbSummary = encodeURIComponent("55 inches and only 4mm thin, the world’s largest and slimmest OLED TV with picture quality that is sheer perfection.");			
